...
public class nAmplificationElementGauche extends Canvas {
    ...
    public static void drawEnergySource(GraphicsContext gc) {
        ...
        //fait le v
        gc.strokeLine(2 + cote, 2, 2, 2 + cote/2);
        gc.strokeLine(2 + cote, 2 + cote, 2, 2 + cote/2); 
    }
}
